...
INSERT INTO Grants (grant_id, theater_id, agency, amount, duration) values (1,19,'Municipality',100000,20);
INSERT INTO Grants (grant_id, theater_id, agency, amount, duration) values (2,21,'Ministry of Culture',200000,20);
INSERT INTO Grants (grant_id, theater_id, agency, amount, duration) values (3,19,'private donors',15000,20);
INSERT INTO Grants (grant_id, theater_id, agency, amount, duration) values (4,21,'Entreprises',23000,20);
...
--------------------------------------------------------------
INSERT INTO Performance_seat (theater_id, row_numbers, seat_number, dates, ticket_id) values (1,12,100,1,1);
INSERT INTO Performance_seat (theater_id, row_numbers, seat_number, dates, ticket_id) values (2,13,100,1,1);
INSERT INTO Performance_seat (theater_id, row_numbers, seat_number, dates, ticket_id) values (1,12,100,1,1);
-------------------------------------------------------------
